...
function VerifyEmailPage() {
  ...
  return (
    <AuthLayout
      illustration={{ type: 'verifyEmail' }}
      headerProps={false}
    >
      <div style={{ maxWidth: 400, margin: '0 auto', width: '100%' }}>
        <AuthHeader
          title={AUTH_MESSAGES.verifyEmail.title}
          subtitle={AUTH_MESSAGES.verifyEmail.subtitle}
        />
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <LoadingButton
            ...
            variant="primary"
            isLoading={isLoading}
            loadingText={AUTH_MESSAGES.verifyEmail.submit}
            className="auth-submit"
            disabled={!otp.isComplete}
          >
            {AUTH_MESSAGES.verifyEmail.submit}
